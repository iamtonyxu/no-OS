...
extern void init_ctune(rf_chip_phy_t *phy, int channel, BANDWIDTH_ENUM bandwith);
...
extern void send_cordic_signal(rf_chip_phy_t *phy, int channel, BANDWIDTH_ENUM bandwith, short en, long freq);
extern void send_edge_signal(rf_chip_phy_t *phy, int channel, BANDWIDTH_ENUM bandwith);
...
extern void set_rf_bandwidth(rf_chip_phy_t *phy, BANDWIDTH_ENUM bandwith);
...
extern short digital_init(rf_chip_phy_t *phy, CHIP_MODE_ENUM mode, BANDWIDTH_ENUM bandwith, DIG_IF_ENUM dif, IF_TYPE_ENUM port, DATA_RATE_ENUM rate, short step);
