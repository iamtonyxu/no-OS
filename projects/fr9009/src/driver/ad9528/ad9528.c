 ...
 */
fRHALErr_t  AD9528_spiWriteField(ad9528Device_t *device,
 ...
 */
fRHALErr_t AD9528_setTimeout_ms(uint32_t timeOut_ms)
{
 ...
 */
fRHALErr_t AD9528_hasTimeoutExpired()
{
	udelay(1000);
 ...
 * \return Returns enum ADI_ERR, ADIERR_OK=pass, !ADIERR_OK=fail
 */
fRHALErr_t AD9528_setSpiSettings(ad9528Device_t *device)
{
	uint8_t spiReg = 0;
					...
					uint32_t outputDeviceClock_Hz)
{
	...
	device->pll1Settings->refB_bufferCtrl =
		SINGLE_ENDED;		   //DISABLED = 0, SINGLE_ENDED, NEG_SINGLE_ENDED, DIFFERENTIAL
	device->pll1Settings->refB_Divider = 1;
	device->pll1Settings->refB_Frequency_Hz = refAFrequency_Hz;
			      ...
			      *device)   //writes all registers to desired values, leaves clock outputs off, SYSREF output disabled.
{
	...
	AD9528_spiWriteByte(device, AD9528_ADDR_STATUS0_CTRL,
			    0x01); //STATUS 0 outputs REFA present
	AD9528_spiWriteByte(device, AD9528_ADDR_STATUS1_CTRL,
			    0x08); //STATUS 1 outputs PLL1 and PLL2 locked
...
#elif 0
#define ad9528_single_wr(a,b)	AD9528_spiWriteByte(device, a , b)
	ad9528_single_wr(0x0,		0x3C),
	ad9528_single_wr(0x1,		0x80),
	ad9528_single_wr(0x3,		0x05),
	ad9528_single_wr(0x4,		0xFF),
	ad9528_single_wr(0x5,		0x00),
	ad9528_single_wr(0x6,		0x03),
	ad9528_single_wr(0xa,		0x00),
	ad9528_single_wr(0xb,		0x00),
	ad9528_single_wr(0xc,		0x56),
	ad9528_single_wr(0xd,		0x04),
	ad9528_single_wr(0xf,		0x00),
	ad9528_single_wr(0x100,		0x01),
	ad9528_single_wr(0x101,		0x00),
	ad9528_single_wr(0x102,		0x01),
	ad9528_single_wr(0x103,		0x00),
	ad9528_single_wr(0x104,		0x04),
	ad9528_single_wr(0x105,		0x00),
	ad9528_single_wr(0x106,		0x0A),
	ad9528_single_wr(0x107,		0x03),
	ad9528_single_wr(0x108,		0x2A),
	ad9528_single_wr(0x109,		0x00),
	ad9528_single_wr(0x10a,		0x02),
	ad9528_single_wr(0x10b,		0x00),
	ad9528_single_wr(0x200,		0xE6),
	ad9528_single_wr(0x201,		0x87),
	ad9528_single_wr(0x202,		0x03),
	ad9528_single_wr(0x203,		0x01),
	ad9528_single_wr(0x204,		0x03),
	ad9528_single_wr(0x205,		0x2A),
	ad9528_single_wr(0x206,		0x00),
	ad9528_single_wr(0x207,		0x00),
	ad9528_single_wr(0x208,		0x09),
	ad9528_single_wr(0x209,		0x00),
	ad9528_single_wr(0x300,		0x00),
	ad9528_single_wr(0x301,		0x00),
	ad9528_single_wr(0x302,		0x09),
	ad9528_single_wr(0x303,		0x00),
	ad9528_single_wr(0x304,		0x00),
	ad9528_single_wr(0x305,		0x04),
	ad9528_single_wr(0x306,		0x00),
	ad9528_single_wr(0x307,		0x00),
	ad9528_single_wr(0x308,		0x09),
	ad9528_single_wr(0x309,		0x40),
	ad9528_single_wr(0x30a,		0x00),
	ad9528_single_wr(0x30b,		0x09),
	ad9528_single_wr(0x30c,		0x00),
	ad9528_single_wr(0x30d,		0x00),
	ad9528_single_wr(0x30e,		0x09),
	ad9528_single_wr(0x30f,		0x00),
	ad9528_single_wr(0x310,		0x00),
	ad9528_single_wr(0x311,		0x09),
	ad9528_single_wr(0x312,		0x00),
	ad9528_single_wr(0x313,		0x00),
	ad9528_single_wr(0x314,		0x09),
	ad9528_single_wr(0x315,		0x00),
	ad9528_single_wr(0x316,		0x00),
	ad9528_single_wr(0x317,		0x09),
	ad9528_single_wr(0x318,		0x00),
	ad9528_single_wr(0x319,		0x00),
	ad9528_single_wr(0x31a,		0x09),
	ad9528_single_wr(0x31b,		0x00),
	ad9528_single_wr(0x31c,		0x00),
	ad9528_single_wr(0x31d,		0x09),
	ad9528_single_wr(0x31e,		0x00),
	ad9528_single_wr(0x31f,		0x00),
	ad9528_single_wr(0x320,		0x09),
	ad9528_single_wr(0x321,		0x00),
	ad9528_single_wr(0x322,		0x00),
	ad9528_single_wr(0x323,		0x09),
	ad9528_single_wr(0x324,		0x40),
	ad9528_single_wr(0x325,		0x00),
	ad9528_single_wr(0x326,		0x09),
	ad9528_single_wr(0x327,		0x00),
	ad9528_single_wr(0x328,		0x00),
	ad9528_single_wr(0x329,		0x09),
	ad9528_single_wr(0x32a,		0x00),
	ad9528_single_wr(0x32b,		0x00),
	ad9528_single_wr(0x32c,		0x00),
	ad9528_single_wr(0x32d,		0x00),
	ad9528_single_wr(0x32e,		0x00),
	ad9528_single_wr(0x400,		0x00),
	ad9528_single_wr(0x401,		0x02),
	ad9528_single_wr(0x402,		0x00),
	ad9528_single_wr(0x403,		0x80),
	ad9528_single_wr(0x404,		0x04),
	ad9528_single_wr(0x500,		0x10),
	ad9528_single_wr(0x501,		0xF5),
	ad9528_single_wr(0x502,		0x0F),
	ad9528_single_wr(0x503,		0xFF),
	ad9528_single_wr(0x504,		0xFF),
#else
#define ad9528_single_wr(a,b)	AD9528_spiWriteByte(device, a , b)
	ad9528_single_wr(0x000,    0xB9);
//    ad9528_block_rd(0x000, rdDataBuf, 5);
    ad9528_single_wr(0x100, 0x01);
    ad9528_single_wr(0x101, 0x00);
    ad9528_single_wr(0x102, 0x01);
    ad9528_single_wr(0x103, 0x00);
    ad9528_single_wr(0x104, 0x04);
    ad9528_single_wr(0x105, 0x00);
    ad9528_single_wr(0x106, 0x8A); //#Force Holdover 0x0A);
    ad9528_single_wr(0x107, 0x03);
    ad9528_single_wr(0x108, 0x2A);
    ad9528_single_wr(0x109, 0x00);
    ad9528_single_wr(0x10A, 0x0A); //#MidVolt Holdover, 0x02);
    ad9528_single_wr(0x10B, 0x00);
    ad9528_single_wr(0x200, 0xE6);
    ad9528_single_wr(0x201, 0x87);
    ad9528_single_wr(0x202, 0x03);
...
//    ad9528_single_wr(0x303, 0x20);//#0x00); OUT1 as  FPGA REF_CK
    ad9528_single_wr(0x303, 0x00);//#0x00); OUT1 as  FPGA REF_CK
    ad9528_single_wr(0x304, 0x00);
    ad9528_single_wr(0x305, 0x04);

    //#ad9528_single_wr(0x309, 0x20);//#0x00); OUT3 as  FPGA SYS_REF
    //#ad9528_single_wr(0x30A, 0x00);
    //#ad9528_single_wr(0x30B, 0x09);


//    ad9528_single_wr(0x327, 0x00); //#OUT13 as REF_CLK
    ad9528_single_wr(0x327, 0x20);//#0x00); OUT13 as REF_CLK
    ad9528_single_wr(0x328, 0x00);
    ad9528_single_wr(0x329, 0x09);
    ...
    ad9528_single_wr(0x400, 0x00); //#K divider [7:0]
    ad9528_single_wr(0x401, 0x0F); //#K divider [15:8]
    ad9528_single_wr(0x402, 0x1C); //#{1'b0,  2'b00,  1'b1, ,1'b1, 2'b10, 1'b0}
    ad9528_single_wr(0x403, 0x9A); //#{2'b10, 2'b01,   3'b101, 1'b0}
    ad9528_single_wr(0x403, 0x9B); //#{2'b10, 2'b01,   3'b101, 1'b1}  //#start the sysref generation

    ad9528_single_wr(0x309, 0xE0); //#{3'b111,  1'b0, 4'b0} //#OUT3 as  FPGA SYS_REF
    ad9528_single_wr(0x324, 0xE0); //#{3'b111,  1'b0, 4'b0} //#out12 setting
    ...
    ad9528_single_wr(0x503, 0xFF);
    ad9528_single_wr(0x504, 0xFF);
    ad9528_single_wr(0x505, 0x07);
    ad9528_single_wr(0x506, 0x01);
    ad9528_single_wr(0x507, 0x0C);


    ad9528_single_wr(0x00F, 0x01); //#涓嬮潰鏃犳硶鍐欏叆
    ad9528_single_wr(0x403, 0x9A); //#{2'b10, 2'b01,   3'b101, 1'b0}//闇�瑕佺浜屾鍐欏叆20221025
    ad9528_single_wr(0x403, 0x9B); //#{2'b10, 2'b01,   3'b101, 1'b1}  //#start the sysref generation
    ad9528_single_wr(0x00F, 0x01); //#涓嬮潰鏃犳硶鍐欏叆
#endif
