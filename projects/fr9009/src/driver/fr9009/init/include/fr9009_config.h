...
#define FHM_MODE_EN 1
#define FHM_TYPE   FR_FHM_AUTO_RF_ORF_MODE //FR_FHM_MANUAL_RF_ORF_MODE, FR_FHM_AUTO_RF_ORF_MODE
#define FHM_SWITCH_FREQ_HZ      10000
#define FHM_RF_TRIGGER_PIN_NUM  FR_GPIO_00
