/**
 * \file fr9009_cals.h
 * \brief Contains FR9009 calibration related function prototypes for
 *        fr9009_cals.c
 *
...
#ifndef FR9009_CALS_H_
#define FR9009_CALS_H_
...
/**
 * \brief Runs the FR9009 initialization calibrations
 *
 ...
 *        the frequency scan range needs to be set via FR9009_SetFhmConfig() API
 *
 * \dep_begin
 ...
 * \param tx_ch tx channel which want to calibration
 * \param rx_ch rx channel which want to calibration
 * \param orx_ch orx channel which want to calibration
 * \param tx1_lp2orx_ch tx1 calibration use which  orx channel
 * \param tx2_lp2orx_ch tx2 calibration use which  orx channel
 * \param calMask A bitmask that informs the FR9009 ARM processor which calibrations to run
 *
...
/**
 * \brief Blocking waits for the FR9009 initialization calibrations to complete
 *
 * \pre This function is called after FR9009_runInitCals to wait for them to finish
 *
 * \dep_begin
 * \dep{device->devHalInfo}
 * \dep_end
 ...
 *                  Error flag enumerated by fr9009InitCalFlags_t. A value of 0 indicates that there
 *                  was no error.
 *
 * \retval TALACT_WARN_RESET_LOG Recovery action for log reset
 * \retval TALACT_ERR_CHECK_PARAM Recovery action for bad parameter check
 ...
 *
 * This function is similar to FR9009_waitInitCals except it does
 ...
 * FR9009_runInitCals() function call
 *
 * \retval TALACT_WARN_RESET_LOG Recovery action for log reset
 * \retval TALACT_ERR_CHECK_PARAM Recovery action for bad parameter check
 * \retval TALACT_ERR_CHECK_TIMER Recovery action for timer time-out check required
 ...
 * Each bit represents a calibration. fr9009InitCalibrations_t defines the unique initialization
 ...
 * calibration set to run during the radio ON state. fr9009TrackingCalibrations_t
 ...
 */
  ...
  * -------------------|------------
  *          [0]       | FR_TRACK_RX1_QEC, 1 = allow pause/resume on this cal, 0 = ignore resumeCalMask setting for this cal
  *          [1]       | FR_TRACK_RX2_QEC  1 = allow pause/resume on this cal, 0 = ignore resumeCalMask setting for this cal
  *          [2]       | FR_TRACK_ORX1_QEC 1 = allow pause/resume on this cal, 0 = ignore resumeCalMask setting for this cal
  *          [3]       | FR_TRACK_ORX2_QEC 1 = allow pause/resume on this cal, 0 = ignore resumeCalMask setting for this cal
  *          [4]       | FR_TRACK_TX1_LOL  1 = allow pause/resume on this cal, 0 = ignore resumeCalMask setting for this cal
  *          [5]       | FR_TRACK_TX2_LOL  1 = allow pause/resume on this cal, 0 = ignore resumeCalMask setting for this cal
  *          [6]       | FR_TRACK_TX1_QEC  1 = allow pause/resume on this cal, 0 = ignore resumeCalMask setting for this cal
  *          [7]       | FR_TRACK_TX2_QEC  1 = allow pause/resume on this cal, 0 = ignore resumeCalMask setting for this cal
  *          [8]       | FR_TRACK_RX1_HD2  1 = allow pause/resume on this cal, 0 = ignore resumeCalMask setting for this cal
  *          [9]       | FR_TRACK_RX2_HD2  1 = allow pause/resume on this cal, 0 = ignore resumeCalMask setting for this cal
  *
  * \dep_begin
  * \dep{device->devHalInfo}
  * \dep_end
  ...
  * fr9009TrackingCalibrations_t enumerated types are or'd together to form the
  ...
  * --------------------|------------
  *           [0]       | FR_TRACK_RX1_QEC, 1 = cal is resumed (running), 0 = cal is paused
  *           [1]       | FR_TRACK_RX2_QEC  1 = cal is resumed (running), 0 = cal is paused
  *           [2]       | FR_TRACK_ORX1_QEC 1 = cal is resumed (running), 0 = cal is paused
  *           [3]       | FR_TRACK_ORX2_QEC 1 = cal is resumed (running), 0 = cal is paused
  *           [4]       | FR_TRACK_TX1_LOL  1 = cal is resumed (running), 0 = cal is paused
  *           [5]       | FR_TRACK_TX2_LOL  1 = cal is resumed (running), 0 = cal is paused
  *           [6]       | FR_TRACK_TX1_QEC  1 = cal is resumed (running), 0 = cal is paused
  *           [7]       | FR_TRACK_TX2_QEC  1 = cal is resumed (running), 0 = cal is paused
  *           [8]       | FR_TRACK_RX1_HD2  1 = cal is resumed (running), 0 = cal is paused
  *           [9]       | FR_TRACK_RX2_HD2  1 = cal is resumed (running), 0 = cal is paused
  *
  * \dep_begin
  * \dep{device->devHalInfo}
  * \dep_end
  ...
  *        of type fr9009TxLolStatus_t is returned to this pointer address
  *
  * \retval TALACT_WARN_RESET_LOG Recovery action for log reset
  * \retval TALACT_ERR_CHECK_PARAM Recovery action for bad parameter check
  * \retval TALACT_ERR_RESET_SPI Recovery action for SPI reset required
  ...
  *        of type fr9009TxQecStatus_t is returned to this pointer address
  *
  * \retval TALACT_WARN_RESET_LOG Recovery action for log reset
  * \retval TALACT_ERR_CHECK_PARAM Recovery action for bad parameter check
  * \retval TALACT_ERR_RESET_SPI Recovery action for SPI reset required
  ...
  *        of type fr9009RxQecStatus_t is returned to this pointer address
  *
  * \retval TALACT_WARN_RESET_LOG Recovery action for log reset
  * \retval TALACT_ERR_CHECK_PARAM Recovery action for bad parameter check
  * \retval TALACT_ERR_RESET_SPI Recovery action for SPI reset required
  ...
  *        of type fr9009OrxQecStatus_t is returned to this pointer address
  *
  * \retval TALACT_WARN_RESET_LOG Recovery action for log reset
  * \retval TALACT_ERR_CHECK_PARAM Recovery action for bad parameter check
  * \retval TALACT_ERR_RESET_SPI Recovery action for SPI reset required
 ...
 *        of type fr9009RxHd2Status_t is returned to this pointer address
 *
 * \retval TALACT_WARN_RESET_LOG Recovery action for log reset
 * \retval TALACT_ERR_CHECK_PARAM Recovery action for bad parameter check
 * \retval TALACT_ERR_RESET_SPI Recovery action for SPI reset required
 ...
 */
 ...
 /**
  * \brief Performs a blocking wait for a FR9009 calibration or Pll Lock
  *
  * \dep_begin
  * \dep{device->devHalInfo}
  * \dep_end
  *
  * \param device Pointer to the FR9009 device data structure containing settings
 ...
 /**
  * \brief Performs a non-blocking read of wait status for a FR9009 calibration or Pll Lock
  *
  * \dep_begin
  * \dep{device->devHalInfo}
  * \dep_end
...
/**
  * \brief Allows setting configuration options for FR9009 Rx HD2 tracking calibration
  *
  ...
  *
  * \pre This function can only be called when the FR9009 ARM is in the Radio Off state (or
...
/**
  * \brief Allows reading configuration options for FR9009 Rx HD2 tracking calibration from
  * FR9009 ARM memory
  *
  * Config values are read from the FR9009 ARM memory and returned at the address of
...
/**
  ...
  * FR9009 ARM init cals have been run. For 4.0 and greater, the function
 ...
 *  The mask can be a combination of the following channel values ( ::fr9009RxDcOffsettEn_t ).
 *
 *     Channel              |  Value  |  Channel description
 * -------------------------|---------|--------------------------
 *  FR_DC_OFFSET_ALL_OFF   |   0x00  | Disable all the channels
 *  FR_DC_OFFSET_RX1       |   0x01  | Enables Rx1
 *  FR_DC_OFFSET_RX2       |   0x02  | Enables Rx1
 ...
 *
 * \retval FR9009_ERR_DIG_DC_OFFSET_INV_ENABLE_MASK enable mask passed to the function is invalid, refer fr9009RxDcOffsettEn_t enum.
 * \retval FR9009_ERR_OK Function completed successfully
 */
 ...
 * The mask returned will be a combination of the following channel values ( ::fr9009RxDcOffsettEn_t ).
 * By default RX BBDC tracking is ON and ORX BBDC tracking is OFF.This API function can be used to change default behavior.
 *
 *    Channel               |  Value  |  Channel description
 * -------------------------|---------|--------------------------
 *  FR_DC_OFFSET_ALL_OFF   |   0x00  | All channels are disabled
 *  FR_DC_OFFSET_RX1       |   0x01  | Rx1 is enabled
 *  FR_DC_OFFSET_RX2       |   0x02  | Rx2 is enabled
 *  FR_DC_OFFSET_ORX1      |   0x04  | ORx1 is enabled
 *  FR_DC_OFFSET_ORX2      |   0x08  | ORx2 is enabled
 *  FR_DC_OFFSET_ALL_ON    |   0x0F  | All channels are enabled
 *
 * <B>Dependencies</B>
 * - device->spiSettings->chipSelectIndex
 *
 ...
 *
 * \retval FR9009_ERR_DIG_DC_OFFSET_NULL_ENABLE_MASK enableMask is NULL
 * \retval FR9009_ERR_OK Function completed successfully
 */
uint32_t FR9009_getDigDcOffsetEn(fr9009Device_t *device, uint8_t *enableMask);

    /**
      * \brief Allows reading FR9009 tracking calibration batch size configuration option
      * from FR9009 ARM memory
      *
      * Config value is read from the FR9009 ARM memory and returned at the address of
      * the batchsize_us enum function parameter.
      *
      * \pre This function can only be called when the FR9009 ARM is in the RadioOff/IDLE state or ready state.
      *
      * \dep_begin
      * \dep{device->devHalInfo}
      * \dep_end
 ...
 *        FR9009_getErrorMessage function.
 *
