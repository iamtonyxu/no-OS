 ...
 *        functions implemented in fr9009_hal.c
 *
...
#ifndef FR9009_HAL_H_
#define FR9009_HAL_H_
...
/**
 * \brief Private wrapper function for FRHAL_spiReadField with error handling
 *
 ...
 *
 * \retval Returns fRHALErr_t enumerated type
 */
fRHALErr_t brSpiReadField(void *devHalInfo, uint32_t addr, uint32_t *fieldVal,
			    uint32_t mask, uint32_t startBit);

/**
 * \brief Private wrapper function for FRHAL_spiWriteField with error handling
 *
...
/**
 * \brief Private wrapper function for FRHAL_spiWriteWord with error handling
 *
 * This function can be called any time after the devHalInfo has been initialized
 * with valid settings by the user
 *
...
/**
 * \brief Wrapper function for FRHAL_spiReadWord with error handling
 *
 * This function can be called any time after the devHalInfo has been initialized
 * with valid settings by the user
 *
...
/**
 * \brief Wrapper function for FRHAL_spiWriteWords with error handling
 *
 * This function can be called any time after the devHalInfo has been initialized
 * with valid settings by the user
 *
...
/**
 * \brief Wrapper function for FRHAL_spiReadWords with error handling
 *
 * This function can be called any time after the devHalInfo has been initialized
 * with valid settings by the user
 *
 ...
 * \retval Returns fRHALErr_t enumerated type
 */
fRHALErr_t brSpiBlockWriteWords(void *devHalInfo, uint32_t addr, uint32_t *data,
			     uint32_t count);

/**
 * \brief Wrapper function for FRHAL_spiBlockReadWords with error handling
 *
 * This function can be called any time after the devHalInfo has been initialized
 * with valid settings by the user
 *
 ...
 * \retval Returns fRHALErr_t enumerated type
 */
fRHALErr_t brSpiBlockReadWords(void *devHalInfo, uint32_t addr, uint32_t *readdata,
			    uint32_t count);
